...
const API_URL = process.env.REACT_APP_API_URL || 'http://ec2-184-73-54-96.compute-1.amazonaws.com:5000/products';
...
function Fproduct() {
  ...
  if (error) {
    return <div className="error-message">{error}</div>; // Show error message if API request fails
  }
