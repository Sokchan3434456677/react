...
// //     setSuccessMessage(`"${product.title}" has been added to your cart!`); // Set the success message
...
//     <div className="card-img">
//       <img
//         src={product.imgSrc} // Corrected the image source to match the key in the JSON
//         alt={product.name}    // Corrected the alt text to match the key in the JSON
//         className="product-image img-fluid"
//         style={{ width: '100%', height: '300px' }}
//       />
//       <div className="cart-concern position-absolute d-flex justify-content-center">
...
//     <div className="card-detail d-flex justify-content-between align-items-center mt-3">
//       <h3 className="card-title fs-6 fw-normal m-0">
//         <a href="index.html">{product.name}</a> {/* Changed to product.name */}
//       </h3>
//       <span className="card-price fw-bold">{product.price}</span> {/* Changed to product.price */}
//     </div>
//   </div>
// );
